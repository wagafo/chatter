all: binary-armhf \
     ...
     share/locale/el/LC_MESSAGES/chatter.robert-ancell.mo \
     share/locale/fi/LC_MESSAGES/chatter.robert-ancell.mo \
     share/locale/fr/LC_MESSAGES/chatter.robert-ancell.mo \
     share/locale/hu/LC_MESSAGES/chatter.robert-ancell.mo \
     share/locale/it/LC_MESSAGES/chatter.robert-ancell.mo \
     share/locale/nl/LC_MESSAGES/chatter.robert-ancell.mo \
     share/locale/pt/LC_MESSAGES/chatter.robert-ancell.mo \
     share/locale/ru/LC_MESSAGES/chatter.robert-ancell.mo \
     share/locale/zh_CN/LC_MESSAGES/chatter.robert-ancell.mo     
...
po/chatter.robert-ancell.pot: $(QML_SOURCES) chatter.desktop.in
	touch po/chatter.robert-ancell.pot
	xgettext --from-code=UTF-8 --language=JavaScript --keyword=tr --keyword=tr:1,2 --add-comments=TRANSLATORS $(QML_SOURCES) -o po/chatter.robert-ancell.pot
	intltool-extract --type=gettext/keys chatter.desktop.in
	xgettext --keyword=N_ chatter.desktop.in.h -j -o po/chatter.robert-ancell.pot
	rm -f chatter.desktop.in.h

share/locale/%/LC_MESSAGES/chatter.robert-ancell.mo: po/%.po
	msgfmt -o $@ $<
